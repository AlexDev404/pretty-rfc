...
# rough smoke test
	...
	gem --version; \
	bundle --version; \
	apt-get update && apt-get install -y postgresql postgresql-contrib postgresql-server-dev-13 libpq-dev;
...
WORKDIR /app
LABEL fly_launch_runtime="ruby"

# ADD start.sh /app/script/start.sh
